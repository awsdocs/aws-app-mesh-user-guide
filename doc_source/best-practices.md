...
This list of practices will help you get the maximum benefit from App Mesh\. To achieve the goal of zero failed requests during planned deployments and during the unplanned loss of some hosts, our recommendations implement the following strategy:
