...
`EgressIgnoredPorts`  
You can add a comma separated list of ports\. Envoy doesn't proxy traffic to these ports\. Even if you list no ports, port 22 is ignored\. **Note:** The maximum number of egress ports that can be ignored is 15.
