...
## Creating a virtual node<a name="vn-create-virtual-node"></a>
 ...
 To create a virtual node using the AWS CLI version 1\.18\.99 or higher, see the example in the AWS CLI reference for the [create\-virtual\-node](https://docs.aws.amazon.com/cli/latest/reference/appmesh/create-virtual-node.html) command\.
