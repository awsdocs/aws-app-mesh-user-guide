# Identity and Access Management for AWS App Mesh<a name="security-iam"></a>
...
How you use AWS Identity and Access Management \(IAM\) differs, depending on the work you do in App Mesh\.
